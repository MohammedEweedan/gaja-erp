    ...
    () => [
      {
        ...
        description: t(
          "finance.settings.currency.desc",
          "Set up the currency for the system."
        ),
      ...
      },
      {
        ...
        description: t(
          "finance.settings.coa.desc",
          "Set up the chart of accounts for the company."
        ),
      ...
      },
      {
        id: 3,
        title: t(
          "finance.settings.accountsDistribution.title",
          "Accounts distribution"
        ),
        description: t(
          "finance.settings.accountsDistribution.desc",
          "Set up the accounts distribution."
        ),
      ...
      },
      {
        ...
        description: t(
          "finance.settings.assetsTypes.desc",
          "Set up the assets types"
        ),
