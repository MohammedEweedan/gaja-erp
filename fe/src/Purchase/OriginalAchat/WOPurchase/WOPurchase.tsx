...
const WOPurchase = () => {
  ...
  const [editOPurchase, setEditOPurchase] = useState<WatchPurchase | null>(
    null
  );
  ...
  const fetchAllDistributions = async () => {
    ...
    try {
      ...
      setDistributions(
        res.data.filter((d: any) => d.PurchaseType === "Watche Purchase")
      );
    } catch {
      setSnackbar({
        open: true,
  ...
  const validateForm = () => {
    ...
    if (!editOPurchase?.reference_number)
      newErrors.reference_number = "Required";
    ...
    if (
      editOPurchase?.retail_price === undefined ||
      editOPurchase.retail_price === null
    )
      newErrors.retail_price = "Required";
    if (
      editOPurchase?.sale_price === undefined ||
      editOPurchase.sale_price === null
    )
      newErrors.sale_price = "Required";
    setErrors(newErrors);
  ...
  const handleRequestApproval = useCallback(async (row: WatchPurchase) => {
    ...
    try {
      ...
      setSnackbar({
        open: true,
        message: err.response?.data?.message || "Failed to send approval email",
        severity: "error",
      });
      setEmailProgress(0);
    ...
    try {
      ...
      if (existingDist) {
        ...
        if (
          ...
          existingDist.distributionDate?.slice(0, 10) !==
    ...
    try {
      ...
      if (filtered.length > 0) {
        setNewDistribution({
          ps: filtered[0].ps,
          distributionDate:
            filtered[0].distributionDate?.slice(0, 10) ||
  ...
  const columns = useMemo<MRT_ColumnDef<WatchPurchase>[]>(
    () => [
      { accessorKey: "id_achat", header: "ID Achat", size: 60 },
      {
        ...
        Cell: ({ row }) => (
          <Box sx={{ whiteSpace: "normal", wordBreak: "break-word" }}>
            {vendors.find((s) => s.ExtraClient_ID === row.original.vendorsID)
              ?.Client_Name || ""}
          </Box>
        ),
      },
        ...
        Cell: ({ row }) => (
          <Box sx={{ display: "flex", flexDirection: "column", gap: 0.5 }}>
            <span style={{ fontWeight: 500 }}>
              Ref: {row.original.reference_number || "-"}
            </span>
      ...
      {
        accessorKey: "bracelet_material",
        header: "Bracelet Material",
        size: 100,
      },
            ...
            >
              {loading ? (
                ...
                <Box
                  ...
                  onError={(e) => {
                    console.error(
                      "[WOPurchase] Image failed to load:",
                      thumb,
                      e
                    );
        ...
        <DialogContent>
          ...
          >
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  label={
                    <span
                      style={{ color: errors.supplier ? "#d32f2f" : undefined }}
                    >
                      Brand (Vendor)
                    </span>
                  }
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  label={
                    <span
                      style={{ color: errors.vendor ? "#d32f2f" : undefined }}
                    >
                      Vendor
                    </span>
                  }
            ...
            <Autocomplete
              ...
              onInputChange={(_e, v) =>
                setEditOPurchase({ ...editOPurchase!, common_local_brand: v })
              }
              renderInput={(params) => (
                <TextField
                  {...params}
                  label={
                    <span
                      style={{ color: errors.model ? "#d32f2f" : undefined }}
                    >
                      Nickname
                    </span>
                  }
                  ...
                  helperText={
                    errors.common_local_brand
                      ? errors.common_local_brand
                      : "The official model name or designation assigned by the manufacturer (e.g., Submariner, Datejust). This is used for cataloging and identification in accordance with manufacturer and industry standards."
                  }
                />
              )}
            />
            ...
            <TextField
              label={
                <span
                  style={{ color: errors.Date_Achat ? "#d32f2f" : undefined }}
                >
                  Purchase date
                </span>
              }
              ...
              helperText={
                errors.Date_Achat
                  ? errors.Date_Achat
                  : "The date the watch was purchased, formatted according to ISO 8601 (YYYY-MM-DD), which is the international standard for date and time representation."
              }
            ...
            <Autocomplete
              ...
              onInputChange={(_e, v) =>
                setEditOPurchase({ ...editOPurchase!, model: v })
              }
              renderInput={(params) => (
                <TextField
                  {...params}
            ...
            <TextField
              label={
                <span
                  style={{ color: errors.DocumentNo ? "#d32f2f" : undefined }}
                >
                  Document Number
                </span>
              }
            ...
            <TextField
              label={
                <span
                  style={{
                    color: errors.reference_number ? "#d32f2f" : undefined,
                  }}
                >
                  Reference Number
                </span>
              ...
              helperText={
                errors.reference_number
                  ? errors.reference_number
                  : "A unique alphanumeric code assigned by the manufacturer to identify a specific watch model or configuration. For dive watches, this may comply with ISO 6425, which standardizes requirements for diver's watches."
              }
            />
            ...
            <TextField
              label={
                <span
                  style={{
                    color: errors.serial_number ? "#d32f2f" : undefined,
                  }}
                >
                  Serial Number
                </span>
              ...
              helperText={
                errors.serial_number
                  ? errors.serial_number
                  : "A unique identifier assigned to each individual watch by the manufacturer, often used for warranty, authentication, and traceability. Serial numbers may follow ISO 7812 for unique identification."
              }
            />
            ...
            <Autocomplete
              ...
              onInputChange={(_e, v) =>
                setEditOPurchase({ ...editOPurchase!, movement: v })
              }
              renderInput={(params) => (
                <TextField
                  {...params}
                  label={
                    <span
                      style={{ color: errors.movement ? "#d32f2f" : undefined }}
                    >
                      Movement
                    </span>
                  }
                  ...
                  helperText={
                    errors.movement
                      ? errors.movement
                      : "The mechanism that drives the watch hands and complications. Common types include Automatic (self-winding), Manual (hand-wound), Quartz (battery-powered), and Spring Drive. ISO 3157 defines terminology for horology."
                  }
                />
              )}
            />
            ...
            <TextField
              label={
                <span style={{ color: errors.caliber ? "#d32f2f" : undefined }}>
                  Caliber
                </span>
              }
              fullWidth
              ...
              onChange={(e) =>
                setEditOPurchase({ ...editOPurchase!, caliber: e.target.value })
              }
              ...
              helperText={
                errors.caliber
                  ? errors.caliber
                  : "The specific model or design of the movement inside the watch, as designated by the manufacturer (e.g., 3135, 1861). Caliber numbers are used for servicing, parts, and technical reference."
              }
            />
            ...
            <Autocomplete
              ...
              onInputChange={(_e, v) =>
                setEditOPurchase({ ...editOPurchase!, gender: v })
              }
              renderInput={(params) => (
                <TextField
                  {...params}
                  label={
                    <span
                      style={{ color: errors.gender ? "#d32f2f" : undefined }}
                    >
                      Gender
                    </span>
                  }
                  ...
                  helperText={
                    errors.gender
                      ? errors.gender
                      : "The intended wearer of the watch, classified as Men, Women, or Unisex. Gender classification may follow ISO 20275 for standardized terminology in product categorization."
                  }
                />
              )}
            />
            ...
            <Autocomplete
              ...
              onInputChange={(_e, v) =>
                setEditOPurchase({ ...editOPurchase!, condition: v })
              }
              renderInput={(params) => (
                <TextField
                  {...params}
                  label={
                    <span
                      style={{
                        color: errors.condition ? "#d32f2f" : undefined,
                      }}
                    >
                      Condition
                    </span>
                  ...
                  helperText={
                    errors.condition
                      ? errors.condition
                      : "Describes the physical state of the watch at the time of purchase. Standardized terms such as New, Unworn, Excellent, Very Good, Good, and Fair are used for consistency in the secondary market and may align with ISO 20275."
                  }
                />
              )}
            />
            ...
            <TextField
              label={
                <span
                  style={{
                    color: errors.diamond_total_carat ? "#d32f2f" : undefined,
                  }}
                >
                  Diamond Total Carat
                </span>
              ...
              onChange={(e) =>
                setEditOPurchase({
                  ...editOPurchase!,
                  diamond_total_carat: Number(e.target.value),
                })
              }
              error={!!errors.diamond_total_carat}
              sx={
                !!errors.diamond_total_carat
                  ? {
                      "& .MuiOutlinedInput-root": {
                        "& fieldset": {
                          borderColor: "#d32f2f",
              ...
              helperText={
                errors.diamond_total_carat
                  ? errors.diamond_total_carat
                  : "The total carat weight of all diamonds set in the watch, measured according to ISO 8653, which specifies methods for determining the mass of precious stones."
              }
            />
            ...
            <Autocomplete
              ...
              onInputChange={(_e, v) =>
                setEditOPurchase({ ...editOPurchase!, diamond_quality: v })
              }
              renderInput={(params) => (
                <TextField
                  {...params}
                  label={
                    <span
                      style={{
                        color: errors.diamond_quality ? "#d32f2f" : undefined,
                      }}
                    >
                      Diamond Quality
                    </span>
                  ...
                  helperText={
                    errors.diamond_quality
                      ? errors.diamond_quality
                      : "The color and clarity grade of diamonds, using GIA (Gemological Institute of America) standards or ISO 24016 for grading polished diamonds. Examples: D (colorless), VS1 (Very Slightly Included)."
                  }
                />
              )}
            />
            ...
            <Autocomplete
              ...
              onInputChange={(_e, v) =>
                setEditOPurchase({ ...editOPurchase!, diamond_setting: v })
              }
              renderInput={(params) => (
                <TextField
                  {...params}
                  label={
                    <span
                      style={{
                        color: errors.diamond_setting ? "#d32f2f" : undefined,
                      }}
                    >
                      Diamond Setting
                    </span>
                  ...
                  helperText={
                    errors.diamond_setting
                      ? errors.diamond_setting
                      : "The technique used to secure diamonds in the watch, such as Pavé, Bezel, Channel, Prong, or Invisible. These are industry-standard terms for jewelry and watchmaking."
                  }
                />
              )}
            />
            ...
            <TextField
              label={
                <span
                  style={{
                    color: errors.number_of_diamonds ? "#d32f2f" : undefined,
                  }}
                >
                  Number of Diamonds
                </span>
              ...
              onChange={(e) =>
                setEditOPurchase({
                  ...editOPurchase!,
                  number_of_diamonds: Number(e.target.value),
                })
              }
              error={!!errors.number_of_diamonds}
              sx={
                !!errors.number_of_diamonds
                  ? {
                      "& .MuiOutlinedInput-root": {
                        "& fieldset": {
                          borderColor: "#d32f2f",
              ...
              helperText={
                errors.number_of_diamonds
                  ? errors.number_of_diamonds
                  : "The total count of individual diamonds set in the watch, used for valuation and certification."
              }
            />
            ...
            <Autocomplete
              ...
              onInputChange={(_e, v) =>
                setEditOPurchase({ ...editOPurchase!, custom_or_factory: v })
              }
              renderInput={(params) => (
                <TextField
                  {...params}
                  label={
                    <span
                      style={{
                        color: errors.custom_or_factory ? "#d32f2f" : undefined,
                      }}
                    >
                      Custom or Factory
                    </span>
                  ...
                  helperText={
                    errors.custom_or_factory
                      ? errors.custom_or_factory
                      : "Indicates whether the watch is in its original factory configuration or has been modified/customized after production (aftermarket). Important for authenticity and value."
                  }
                />
              )}
            />
            ...
            <Autocomplete
              ...
              onInputChange={(_e, v) =>
                setEditOPurchase({ ...editOPurchase!, case_material: v })
              }
              renderInput={(params) => (
                <TextField
                  {...params}
                  label={
                    <span
                      style={{
                        color: errors.case_material ? "#d32f2f" : undefined,
                      }}
                    >
                      Case Material
                    </span>
                  ...
                  helperText={
                    errors.case_material
                      ? errors.case_material
                      : "The material used for the watch case, such as Stainless Steel, Gold (Yellow/White/Rose), Platinum, Titanium, Ceramic, or Carbon. ISO 8654 specifies the composition and marking of precious metals."
                  }
                />
              )}
            />
            ...
            <TextField
              label={
                <span
                  style={{ color: errors.case_size ? "#d32f2f" : undefined }}
                >
                  Case Size (mm)
                </span>
              }
              ...
              helperText={
                errors.case_size
                  ? errors.case_size
                  : "The diameter of the watch case, measured in millimeters (mm) according to ISO 286, which defines tolerances for linear dimensions."
              }
            />
            ...
            <TextField
              label={
                <span style={{ color: errors.bezel ? "#d32f2f" : undefined }}>
                  Bezel
                </span>
              }
              fullWidth
              ...
              onChange={(e) =>
                setEditOPurchase({ ...editOPurchase!, bezel: e.target.value })
              }
              error={!!errors.bezel}
              sx={
                !!errors.bezel
              ...
              helperText={
                errors.bezel
                  ? errors.bezel
                  : "The type and function of the bezel, such as Rotating (for divers), Fixed, or Tachymeter (for chronographs). The bezel is the ring surrounding the watch crystal."
              }
            />
            ...
            <TextField
              label={
                <span
                  style={{
                    color: errors.bracelet_type ? "#d32f2f" : undefined,
                  }}
                >
                  Bracelet Type
                </span>
              ...
              onChange={(e) =>
                setEditOPurchase({
                  ...editOPurchase!,
                  bracelet_type: e.target.value,
                })
              }
              error={!!errors.bracelet_type}
              sx={
                !!errors.bracelet_type
                  ? {
                      "& .MuiOutlinedInput-root": {
                        "& fieldset": {
                          borderColor: "#d32f2f",
              ...
              helperText={
                errors.bracelet_type
                  ? errors.bracelet_type
                  : "The style or construction of the bracelet, such as Oyster, Jubilee, Leather, Rubber, or Mesh. This affects comfort, appearance, and value."
              }
            />
            ...
            <TextField
              label={
                <span
                  style={{
                    color: errors.bracelet_material ? "#d32f2f" : undefined,
                  }}
                >
                  Bracelet Material
                </span>
              ...
              onChange={(e) =>
                setEditOPurchase({
                  ...editOPurchase!,
                  bracelet_material: e.target.value,
                })
              }
              error={!!errors.bracelet_material}
              sx={
                !!errors.bracelet_material
                  ? {
                      "& .MuiOutlinedInput-root": {
                        "& fieldset": {
                          borderColor: "#d32f2f",
              ...
              helperText={
                errors.bracelet_material
                  ? errors.bracelet_material
                  : "The material of the bracelet, which may include metals (ISO 8654), leather, rubber, or fabric. Material impacts durability and aesthetics."
              }
            />
            ...
            <TextField
              label={
                <span
                  style={{ color: errors.dial_color ? "#d32f2f" : undefined }}
                >
                  Dial Color
                </span>
              }
              ...
              helperText={
                errors.dial_color
                  ? errors.dial_color
                  : "The color of the watch dial, described using standard color names or codes (ISO 11664 for colorimetry)."
              }
            />
            ...
            <TextField
              label={
                <span
                  style={{ color: errors.dial_style ? "#d32f2f" : undefined }}
                >
                  Dial Style
                </span>
              }
              ...
              helperText={
                errors.dial_style
                  ? errors.dial_style
                  : "The decorative style or finish of the dial, such as Sunburst, Guilloché, Skeleton, or Enamel. Dial style contributes to the watch's uniqueness and value."
              }
            />
            ...
            <TextField
              label={
                <span style={{ color: errors.crystal ? "#d32f2f" : undefined }}>
                  Crystal
                </span>
              }
              fullWidth
              ...
              onChange={(e) =>
                setEditOPurchase({ ...editOPurchase!, crystal: e.target.value })
              }
              ...
              helperText={
                errors.crystal
                  ? errors.crystal
                  : "The transparent cover over the dial, made from materials such as Sapphire, Mineral Glass, or Acrylic. Crystal type affects scratch resistance and clarity."
              }
            />
            ...
            <TextField
              label={
                <span
                  style={{
                    color: errors.water_resistance ? "#d32f2f" : undefined,
                  }}
                >
                  Water Resistance
                </span>
              ...
              helperText={
                errors.water_resistance
                  ? errors.water_resistance
                  : "The watch's ability to resist water ingress, expressed in meters (m), atmospheres (ATM), or bar. ISO 22810 defines water resistance for watches."
              }
            />
            ...
            <TextField
              label={
                <span
                  style={{ color: errors.functions ? "#d32f2f" : undefined }}
                >
                  Functions
                </span>
              }
              ...
              helperText={
                errors.functions
                  ? errors.functions
                  : "Additional features beyond basic timekeeping, known as complications (e.g., Chronograph, GMT, Date, Moonphase)."
              }
            />
            ...
            <TextField
              label={
                <span
                  style={{
                    color: errors.power_reserve ? "#d32f2f" : undefined,
                  }}
                >
                  Power Reserve
                </span>
              ...
              onChange={(e) =>
                setEditOPurchase({
                  ...editOPurchase!,
                  power_reserve: e.target.value,
                })
              }
              error={!!errors.power_reserve}
              sx={
                !!errors.power_reserve
                  ? {
                      "& .MuiOutlinedInput-root": {
                        "& fieldset": {
                          borderColor: "#d32f2f",
              ...
              helperText={
                errors.power_reserve
                  ? errors.power_reserve
                  : "The amount of time (in hours) the watch will run from full wind until it stops, indicating the energy storage capacity of the movement."
              }
            />
            ...
            <Autocomplete
              ...
              onChange={(_e, v) =>
                setEditOPurchase({ ...editOPurchase!, box_papers: v ?? false })
              }
              renderInput={(params) => (
                <TextField
                  {...params}
                  label={
                    <span
                      style={{
                        color: errors.box_papers ? "#d32f2f" : undefined,
                      }}
                    >
                      Box/Papers
                    </span>
                  ...
                  helperText={
                    errors.box_papers
                      ? errors.box_papers
                      : "Indicates whether the original manufacturer’s box and documentation (papers) are included. These items are important for authenticity, provenance, and resale value."
                  }
                />
              )}
            />
            ...
            <Box sx={{ display: "flex", gap: 2 }}>
              ...
              <TextField
                label={
                  <span
                    style={{
                      color: errors.discount_by_vendor ? "#d32f2f" : undefined,
                    }}
                  >
                    Discount
                  </span>
                ...
                onChange={(e) =>
                  setEditOPurchase({
                    ...editOPurchase!,
                    discount_by_vendor: Number(e.target.value),
                  })
                }
                inputProps={{ min: 0, step: 1 }}
              ...
              <FormControl fullWidth sx={{ flex: 1 }}>
                <Autocomplete
                  ...
                  value={
                    currencyList.find(
                      (cur) =>
                        cur.code === (editOPurchase?.currencyRetail || "")
                    ) || null
                  }
                  onChange={(_e, newValue) =>
                    setEditOPurchase((prev) =>
                      prev
                        ? {
                            ...prev,
                            currencyRetail: newValue ? newValue.code : "",
                          }
                        : prev
                    )
                  }
            ...
            <Box sx={{ display: "flex", gap: 2 }}>
              <TextField
                ...
                onChange={(e) =>
                  setEditOPurchase({
                    ...editOPurchase!,
                    reaRetail: Number(e.target.value),
                  })
                }
              ...
              <TextField
                ...
                value={
                  ...
                  editOPurchase.reaRetail &&
                  editOPurchase.RateToLYD
                    ? (
                        Number(editOPurchase.retail_price) *
                        Number(editOPurchase.reaRetail)
                      ).toFixed(2)
                    : ""
                }
            ...
            <TextField
              label={
                <span
                  style={{ color: errors.RateToLYD ? "#d32f2f" : undefined }}
                >
                  Rate To LYD
                </span>
              }
              ...
              onChange={(e) =>
                setEditOPurchase({
                  ...editOPurchase!,
                  RateToLYD: Number(e.target.value),
                })
              }
              ...
              value={
                ...
                editOPurchase.RateToLYD
                  ? (
                      Number(editOPurchase.retail_price) *
                      Number(editOPurchase.reaRetail) *
                      Number(editOPurchase.RateToLYD)
                    ).toFixed(2)
                  : ""
              }
              InputProps={{ readOnly: true }}
            ...
            <TextField
              label={
                <span
                  style={{
                    color: errors.manufactureDate ? "#d32f2f" : undefined,
                  }}
                >
                  Manufacture Date
                </span>
              ...
              onChange={(e) =>
                setEditOPurchase((prev) =>
                  prev ? { ...prev, manufactureDate: e.target.value } : prev
                )
              }
              required
              ...
              helperText={
                errors.manufactureDate
                  ? errors.manufactureDate
                  : "The date the watch was manufactured, formatted according to ISO 8601 (YYYY-MM-DD). This information is crucial for determining the age and authenticity of the watch."
              }
            />
            ...
            <TextField
              label={
                <span
                  style={{ color: errors.sale_price ? "#d32f2f" : undefined }}
                >
                  Sales Price
                </span>
              }
            ...
            <TextField
              label={
                <span
                  style={{ color: errors.ExpiryDate ? "#d32f2f" : undefined }}
                >
                  Expiry Date
                </span>
              }
            ...
            <TextField
              label={
                <span
                  style={{ color: errors.warranty ? "#d32f2f" : undefined }}
                >
                  Warranty
                </span>
              }
