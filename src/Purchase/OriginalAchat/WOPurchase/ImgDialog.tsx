        ...
        <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
            ...
            <DialogContent>
                ...
                <Box mb={2}>
                    ...
                    {selectedFile && (
                        <Button onClick={handleUpload} variant="outlined" sx={{ ml: 2 }} disabled={uploading}>
            ...
            {/* Zoom Dialog */}
            <Dialog open={!!zoomImg} onClose={() => setZoomImg(null)} maxWidth={false} fullScreen>
                <Box sx={{ position: 'relative', bgcolor: '#000', width: '100vw', height: '100vh', p: 0, m: 0, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <Button onClick={() => setZoomImg(null)} sx={{ position: 'absolute', top: 16, right: 16, zIndex: 2, color: '#fff', background: 'rgba(0,0,0,0.4)', fontSize: 20, px: 2, py: 1 }}>Close</Button>
                    {zoomImg && (
                        <Box
                            component="img"
                            src={zoomImg}
            ...
            <Dialog open={showCamera} onClose={() => setShowCamera(false)} maxWidth="md" fullWidth>
                <Box sx={{ p: 2, display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', maxWidth: 700, mx: 'auto' }}>
