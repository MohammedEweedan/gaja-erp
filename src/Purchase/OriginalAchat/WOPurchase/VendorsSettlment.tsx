...
const VendorsSettlment = () => {
  ...
  const validateForm = () => {
    ...
    if (!editSettlement?.client || editSettlement.client < 0)
      newErrors.client = "Vendor must be selected";
    ...
    if (!editSettlement?.Paidby || editSettlement.Paidby < 0)
      newErrors.Paidby = "Vendor paid by must be selected";
    ...
    <Box p={0.5}>
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2, mt: 2 }}>
            ...
            >
              ...
              <Autocomplete
                ...
                value={
                  vendors.find(
                    (v) => v.ExtraClient_ID === editSettlement?.Brand
                  ) || null
                }
                onChange={(_event, newValue) => {
                  setEditSettlement(
              ...
              <Autocomplete
                ...
                value={
                  suppliers.find(
                    (v) => v.id_client === editSettlement?.client
                  ) || null
                }
                onChange={(_event, newValue) => {
                  setEditSettlement(
            ...
            >
              <TextField
                ...
                onChange={(e) =>
                  setEditSettlement({
                    ...editSettlement!,
                    Debit_Gold: Number(e.target.value),
                  })
                }
                sx={{ flex: 1, minWidth: 180 }}
              />
              <TextField
                ...
                onChange={(e) =>
                  setEditSettlement({
                    ...editSettlement!,
                    Credit_Gold: Number(e.target.value),
                  })
                }
                sx={{ flex: 1, minWidth: 180 }}
              />
      ...
      <Box sx={{ mt: 4, p: 2, bgcolor: "inherit", borderRadius: 2 }}>
        <Typography variant="body2" color="textSecondary">
          <b>Note:</b> This list displays all vendor payments. Amounts are shown
          in the original currency, converted to USD, and then to LYD using the
          provided exchange rates. <br />
          <b>Original Currency</b> → <b>USD</b> → <b>LYD</b>.<br />
          <b>Vendors</b> refer to the external parties receiving payment, while{" "}
          <b>Brands</b> represent the associated supplier or product line.{" "}
          <br />
          Please review all exchange rates and payment details carefully. If you
          have questions about the conversion or the relationship between
          vendors and brands, contact the finance department for clarification.
        </Typography>
      </Box>
    </Box>
  );
