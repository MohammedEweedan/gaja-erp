...
const WNew_p = (props: NewPProps) => {
  ...
  const { num_fact, distribution, onReceived, brand, referencePurchase } =
    props;
        ...
        if (details && details[0]?.purchaseW) {
          ...
          const vendorObj = details[0].purchaseW.supplier
            ? {
                ...
                TYPE_SUPPLIER:
                  details[0].purchaseW.supplier.TYPE_SUPPLIER ||
                  "Watche Purchase",
              }
            : {
                id_client: 0,
    ...
    try {
      ...
      const payloadData = {
        ...
        Selling_Price_Currency: isUsedSupplier
          ...
          : (productDetails?.[0]?.purchaseW?.sale_price ??
            editPurchase.Selling_Price_Currency ??
            0),
      ...
      if (isEditMode) {
        const response = await axios.put(
          `${apiUrl}/Update/${editPurchase.id_fact}`,
          payload,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.supplier?.client_name ||
                          productDetails[0].purchaseW.Brand ||
                          "N/A"}
                      </td>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                        Model:
                      ...
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.model}
                      </td>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                        Reference Number:
                      </td>
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.reference_number}
                      </td>
                    </tr>
                    <tr>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                      ...
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.serial_number}
                      </td>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                        Movement:
                      </td>
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.movement}
                      </td>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                        Caliber:
                      </td>
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.caliber}
                      </td>
                    </tr>
                    <tr>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                      ...
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.gender}
                      </td>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                        Condition:
                      </td>
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.condition}
                      </td>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                        Diamond Total Carat:
                      </td>
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.diamond_total_carat}
                      </td>
                    </tr>
                    <tr>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                      ...
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.diamond_quality}
                      </td>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                        Diamond Setting:
                      </td>
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.diamond_setting}
                      </td>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                        Number of Diamonds:
                      </td>
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.number_of_diamonds}
                      </td>
                    </tr>
                    <tr>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                      ...
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.custom_or_factory}
                      </td>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                        Case Material:
                      </td>
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.case_material}
                      </td>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                        Case Size:
                      </td>
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.case_size}
                      </td>
                    </tr>
                    <tr>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                      ...
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.bezel}
                      </td>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                        Bracelet Type:
                      </td>
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.bracelet_type}
                      </td>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                        Bracelet Material:
                      </td>
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.bracelet_material}
                      </td>
                    </tr>
                    <tr>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                      ...
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.dial_color}
                      </td>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                        Dial Style:
                      </td>
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.dial_style}
                      </td>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                        Crystal:
                      </td>
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.crystal}
                      </td>
                    </tr>
                    <tr>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                      ...
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.water_resistance}
                      </td>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                        Functions:
                      </td>
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.functions}
                      </td>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                        Power Reserve:
                      </td>
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.power_reserve}
                      </td>
                    </tr>
                    <tr>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
                      ...
                      <td style={{ color: valueColor }}>
                        {productDetails[0].purchaseW.box_papers ? "Yes" : "No"}
                      </td>
                    </tr>
                    <tr>
                      <td style={{ color: labelColor, fontWeight: 500 }}>
