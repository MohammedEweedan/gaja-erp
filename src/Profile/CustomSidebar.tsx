...
function CustomSidebar({ navigation, routeMap, mode, onToggleTheme, onLogout }: CustomSidebarProps) {
    ...
    return (
        <Box sx={{ width: 260, height: '100%', display: 'flex', flexDirection: 'column', bgcolor: 'background.paper' }}>
            ...
            <Box sx={{ p: 2, borderTop: theme => `1px solid ${theme.palette.divider}`, display: 'flex', justifyContent: 'space-between' }}>
                <IconButton
